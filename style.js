...
let numbers = [3, -90, 98, 546, -3, 55, 76, 29999, 0, -89, 456, 0.78, -98, 5432, 34, 56.78, 89, -98, 67, 54321, 1000]
/*
...
/*
let filter = numbers.filter(a => !(a % 3) && !(a === 0));
console.log(filter)
*/
...
/*
let filter2 = numbers.filter(a => !(a % 10) && !(a === 0));
console.log(filter2)
*/
...
/*
let map = numbers.map((value, index) => value * 3);
console.log(map);
*/
...
let words = ["sun", "rain", "october", "winter", "spring", "weekend", "job", "work", "friday", "summer", "june", "july", "monday", "car", "vocabulary", "computer", "pen", "author", "bed", "pencilbox"];

// -- отсортировать его по алфавиту в восходящем порядке.
/*
let sortAa = words.sort((a,b) => a < b? -1:1);
console.log(sortAa)
*/
...
/*
let ageMin = users.sort((a,b) => a.age - b.age );
console.log(ageMin);
*/
/*
let ageMax = users.sort((a,b) => b.age - a.age );
console.log(ageMax);
*/

// - відсортувати його за кількістю знаків в імені  (зростання , а потім окремо спадання)
/*
let countLetter = users.sort((a,b) => a.name.length - b.name.length);
console.log(countLetter);
*/
/*
let countLetter2 = users.sort((a,b) => b.name.length - a.name.length);
console.log(countLetter2);
*/
...
let parse = JSON.parse(json)
let idField = parse.map((user,index) => {
    user.id = index + 3
    return user    
})
console.log(idField)
...
/*
let sort = idField.sort((a,b) => a.id > b.id? -1:1);
console.log(sort)
*/
...
// - двигун = 2л
/*
let filter2 = cars.filter(item => item.volume === 3);
console.log(filter2);
*/
...
// - двигун більше 3х літрів + виробник мерседес
/*
let producer2 = cars.filter(item => (item.volume >= 3) && (item.producer === "mercedes"));
console.log(producer2);
*/

// - двигун більше 3х літрів + виробник субару
/*
let producer3 = cars.filter(item => (item.volume >= 3) && (item.producer === "subaru"));
console.log(producer3);
*/
...
// - мотор серіі ej
/*
 let engine = cars.filter(item => item.engine.startsWith('ej'));
 console.log(engine)
*/
// - сили більше ніж 300 + виробник субару + мотор серіі ej
/*
let engine2 = cars.filter(item => (item.power >= 300) && (item.producer === "subaru") && (item.engine.startsWith('ej')));
console.log(engine2);
*/
// - двигун меньше 3х літрів + виробник мерседес
/*
let powerMin = cars.filter(item => (item.volume < 3) && (item.producer === "mercedes"));
console.log(powerMin)
*/

// - двигун більше 2л + сили більше 250
/*
let volume = cars.filter(item => (item.volume > 2) && (item.power > 250));
console.log(volume);
*/
// - сили більше 250  + виробник бмв
/*
let volume2 = cars.filter(item => (item.power > 250) && (item.producer === "bmw"));
console.log(volume2);
*/
...
// -- отсортировать его по id пользователей в обратном опрядке
/*
let id1 = usersWithAddress.sort((a, b) => b.id - a.id);
console.log(id1);
*/
// -- отсортировать его по возрасту пользователей
/*
...
// -- отсортировать его по возрасту пользователей в обратном порядке
/*
let age2 =  usersWithAddress.sort((a, b) => b.age - a.age);
console.log(age2);
*/
// -- отсортировать его по имени пользователей
/*
